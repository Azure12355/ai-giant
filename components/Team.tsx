      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {CORE_TEAM.map((member, index) => (
            <div key={index} className="glass group relative p-6 rounded-2xl border border-white/5 bg-slate-900/40 overflow-hidden hover:bg-slate-900/80 transition-all duration-300 hover:border-brand-500/30">
