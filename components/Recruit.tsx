...
const Recruit: React.FC = () => {
  return (
    <section id="join" className="py-24 bg-gradient-to-b from-black to-brand-950/30 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Recruitment Requirements */}
        <div className="glass-gold rounded-3xl p-8 md:p-12 bg-black/50 mb-16">
        ...
        <div className="text-center relative">
          ...
          <p className="text-xl text-slate-300 mb-10 max-w-3xl mx-auto italic">
            “AI不是风口，而是未来十年的水和电。今天我们种下的种子，明天将长成参天大树。” —— 七天
          </p>
          <button className="bg-gradient-to-r from-brand-500 to-brand-700 text-white font-bold py-4 px-12 rounded-full text-lg shadow-[0_0_30px_rgba(245,158,11,0.4)] hover:scale-105 transition-transform duration-200 ring-4 ring-brand-500/20 border border-brand-400/30">
            立即加入我们
          </button>
        </div>
      </div>
